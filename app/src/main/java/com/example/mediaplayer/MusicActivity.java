...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play = (ImageView)findViewById(R.id.play_stop);
        //pause = (ImageView)findViewById(R.id.play_stop);
...
//            }
            ...
            Bitmap bitmap = BitmapFactory.decodeFile(getCoverArtPath(
                    Long.parseLong(musicDto.getAlbumId()),getApplication()));
